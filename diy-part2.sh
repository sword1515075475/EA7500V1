...
# 版本号里显示自己名字
sed -i "s/OpenWrt /Max build 20220628 @ Linksys EA8500 Router /g" package/lean/default-settings/files/zzz-default-settings

sed -i 's/"Turbo ACC 网络加速"/"网络加速"/g' package/luci/applications/luci-app-turboacc/po/zh-cn/turboacc.po
